...
questions_list = [] 
questions_list.append(Question('Кто тренер сборной России','Карпин','Черчесов','Шевченко','Роналду'))
questions_list.append(Question('Самое высокое звание в ксго','Глобал','Калаши','Сильвер 1','Калаш'))
questions_list.append(Question('Кто выиграли 16 миллионов $','Team Spirit','NaVi','Gambit','OG'))
